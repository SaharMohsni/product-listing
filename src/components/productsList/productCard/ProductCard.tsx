...
import { selectBasketProducts, selectLoading } from '../../../features/selectors/products.selectors';
...
const ProductCard: React.FC<IOwnProps> = ({ product }) => {
	...
	return (
		<div className="product-card global-flex-column-h-any-v-between" key={product.slug}>
			...
			<Skeleton {...skeleton.descriptionSkeleton(loading.fetchingProductByPage)}>
